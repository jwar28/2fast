            ...
            <div className="container px-4 md:px-6">
                <div className="flex flex-col items-center justify-center space-y-4 text-center">
                    <div className="space-y-2">
                        <div className="inline-block rounded-lg bg-rose-100 px-3 py-1 text-sm text-rose-500">Socios</div>
                    ...
                    <div className="flex flex-col justify-center space-y-8">
                        <div className="flex items-start gap-4">
                            ...
                            <div>
                                ...
                                <p className="text-muted-foreground">Llega a miles de nuevos clientes y aumenta tus ingresos.</p>
                            </div>
                        </div>
                        <div className="flex items-start gap-4">
                            <div className="rounded-full bg-rose-100 p-2">
                            ...
                            <div>
                                ...
                                <p className="text-muted-foreground">Nuestro sistema de entrega te permite enfocarte en tu negocio.</p>
                            </div>
                        </div>
                        <div className="flex items-start gap-4">
                            <div className="rounded-full bg-rose-100 p-2">
                            ...
                            <div>
                                ...
                                <p className="text-muted-foreground">
                                    Promociona tu negocio en nuestra plataforma y llega a más clientes.
                                </p>
                            </div>
                        </div>
