        ...
        <header className="sticky top-0 z-50 w-full border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
            <div className="container flex h-16 items-center justify-between px-10">
                ...
                <nav className="hidden md:flex items-center gap-6">
                    ...
                    <Link href="#how-it-works" className="text-sm font-medium hover:text-rose-500 transition-colors">
                        Cómo funciona
                    </Link>
                    <Link href="#benefits" className="text-sm font-medium hover:text-rose-500 transition-colors">
                        Beneficios
                    </Link>
                    <Link href="#partners" className="text-sm font-medium hover:text-rose-500 transition-colors">
                        Socios
                    </Link>
