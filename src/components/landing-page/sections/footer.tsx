                ...
                <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4">
                    <div className="space-y-4">
                        ...
                        <p className="text-sm text-muted-foreground">
                            La plataforma líder de delivery en Latinoamérica. Todo lo que necesitas, entregado al instante.
                        </p>
                    </div>
                    <div className="space-y-4">
                    ...
                    <div className="space-y-4">
                        ...
                        <ul className="space-y-2">
                            <li className="text-sm text-muted-foreground">contacto@toofast.com</li>
                            <li className="text-sm text-muted-foreground">+1 (555) 123-4567</li>
                            <li className="text-sm text-muted-foreground">Av. Principal 123, Ciudad</li>
                        </ul>
