            ...
            <div className="container px-4 md:px-6">
                <div className="flex flex-col items-center justify-center space-y-4 text-center">
                    <div className="space-y-2">
                        <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl">Descarga nuestra app</h2>
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 mt-6">
                        <Button variant="outline" className="bg-white text-rose-500 hover:bg-rose-50 border-white h-12 px-6">
                            <Image
                    ...
                    <div className="mt-8 grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                        ...
                        <div className="space-y-4">
                            <h3 className="text-2xl font-bold">Descubre un mundo de posibilidades</h3>
